<template>
  ...
  <div class="relative bg-yellow-50 overflow-hidden max-h-screen">
    ...
    <aside
      class="fixed inset-y-0 left-0 bg-white max-h-screen w-[13em] overflow-y-auto top-[70px]"
    >
    ...
    <aside
      class="fixed inset-y-0 left-[13em] w-[13em] bg-white max-h-screen w-50 overflow-y-auto top-[70px]"
    >
      <div class="flex flex-col justify-between h-full">
        <div class="p-4">
          <ul class="space-y-1">
